...
function sidebarType(a) {
  ...
  if ((color == 'bg-white') && bodyWhite) {
    ...
    var navbarBrandImg = navbarBrand ? navbarBrand.src : null;
...
function darkMode(el) {
  ...
  const navbarBrandImg = navbarBrand ? navbarBrand.src : null;
  ...
  if (!el.getAttribute("checked")) {
    ...
    //   if (breadcrumbItems[i].classList.contains('light')) {
    //     breadcrumbItems[i].classList.add('dark');
    //     breadcrumbItems[i].classList.remove('light');
    //   }
    // }
    for (var i = 0; i < hr.length; i++) {
